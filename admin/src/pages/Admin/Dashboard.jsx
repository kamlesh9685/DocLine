...
const Dashboard = () => {
  // Context se zaroori cheezein le rahe hain. backendUrl ki yahan zaroorat nahi padegi.
    ...
    dashData && (
      <div className="p-6 space-y-8 bg-gray-50 min-h-screen">
        ...
        <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-red-500 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
          {/* ... (Is section mein koi badlaav nahi hai) ... */}
                    ...
                    <div className="flex items-center gap-6">
                      <div className="relative">
                        {/* --- YAHAN BADLAAV KIYA GAYA HAI ---
                          1. `src` mein `item.docData.image` ka istemal kiya gaya hai, na ki `item.patientData.image`.
                          2. `backendUrl` ko hata diya gaya hai kyunki aapka purana code bina uske chal raha tha, jiska matlab hai ki backend se poora URL aa raha hai.
                          3. `alt` ko doctor ke naam se update kiya hai.
                        */}
                        <img 
